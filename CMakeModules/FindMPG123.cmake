...
#  MPG123_LIBRARY     - the mpg123 library
...
if ("${CMAKE_C_COMPILER_ID}" STREQUAL "MSVC")
  ...
  set(MPG123_LIBRARIES ${MPG123_LIBRARIES} ${MPG123_CFLAGS_OTHER})
  find_path(MPG123_INCLUDE_DIR NAMES mpg123.h HINTS ${MPG123_INCLUDE_DIRS})
  find_library(MPG123_LIBRARY NAMES mpg123 HINTS ${MPG123_LIBRARY_DIRS})
  find_package(PackageHandleStandardArgs QUIET REQUIRED)
  find_package_handle_standard_args(mpg123
    REQUIRED_VARS MPG123_LIBRARY MPG123_LIBRARIES MPG123_INCLUDE_DIR
    VERSION_VAR MPG123_VERSION)
endif()

mark_as_advanced(MPG123_INCLUDE_DIR MPG123_LIBRARY MPG123_LIBRARIES)
